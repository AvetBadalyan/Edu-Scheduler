...
import { DEMO_CREDENTIALS, clearError, loginThunk, selectAuthError, selectAuthLoading, selectIsAuthenticated } from '@/store/authSlice'
    ...
    <main id="main-content" className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 to-indigo-100 px-4 py-10">
      <div className="w-full max-w-sm rounded-xl border bg-card p-8 shadow-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to build and manage class schedules</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <div className="flex flex-col gap-1">
            ...
            <Input id="password" type="password" autoComplete="current-password"
              ...
              aria-invalid={!!error} aria-describedby={error ? 'login-error' : undefined} required />
          </div>
