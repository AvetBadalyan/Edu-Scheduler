 ...
 * generated schedules.
 */
import type { CreateFacultyInput, CreateLecturerInput, CreateRoomInput, Student } from "@/types"
...
export const seedLecturers: CreateLecturerInput[] = [
  { name: "Gago", surname: "Gagyan", specialties: ["Java"], imageUrl: Gago, availability: emptyTimetable() },
  { name: "Avet", surname: "Badalyan", specialties: ["UI/UX"], imageUrl: Avet, availability: emptyTimetable() },
  { name: "Eduard", surname: "Harutyunyan", specialties: ["ReactJS", "JavaScript"], imageUrl: Eduard, availability: emptyTimetable() },
  { name: "Norayr", surname: "Hayrikyan", specialties: ["Project Management"], imageUrl: Norayr, availability: emptyTimetable() },
  { name: "Elen", surname: "Ghazaryan", specialties: ["JavaScript"], imageUrl: Elen, availability: emptyTimetable() },
  { name: "Edgar", surname: "Khudoyan", specialties: ["NodeJS"], imageUrl: Edgar, availability: emptyTimetable() },
  { name: "Rafayel", surname: "Afrikyan", specialties: ["CSS", "HTML"], imageUrl: Rafayel, availability: emptyTimetable() },
  { name: "Hovhannes", surname: "Kocharyan", specialties: ["ReactJS"], imageUrl: Hovhannes, availability: emptyTimetable() },
  { name: "Sona", surname: "Shahgeldyan", specialties: ["NodeJS"], imageUrl: Sona, availability: emptyTimetable() },
  { name: "Elmira", surname: "Avagyan", specialties: ["JavaScript"], imageUrl: Elmira, availability: emptyTimetable() },
  { name: "Vrezh", surname: "Oganesyan", specialties: ["HTML"], imageUrl: Vrezh, availability: emptyTimetable() },
  { name: "Anna", surname: "Minasyan", specialties: ["Python"], imageUrl: Anna, availability: emptyTimetable() },
]
